...
To view your deployed application open the Stack View window by double-clicking the wstack name shown beneath the AWS CloudFormation node in the AWS Explorer tree. The Stack View also displays the root URL to your published application.
...
Execute unit tests
```
    cd "MADNetworking.AWS/test/MADNetworking.AWS.Tests"
    dotnet test
```

Deploy application
```
    cd "MADNetworking.AWS/src/MADNetworking.AWS"
